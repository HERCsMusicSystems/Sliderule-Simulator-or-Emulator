...
pythagoreanTests ['Find b on the P scale test'] = function (message) {
  ...
  sliderules . objective = function () {
    if (checkValue ('P', b)) {message ("Mission accomplished!"); increaseCookieResult ('Find b on the P scale test'); return true;}
    return false;
  };
};
...
pythagoreanTests ['Find b on the D scale test'] = function (message) {
  ...
  sliderules . objective = function () {
    if (checkValue ('D', bb)) {message ("Mission accomplished!"); increaseCookieResult ('Find b on the D scale test'); return true;}
    return false;
  };
};
