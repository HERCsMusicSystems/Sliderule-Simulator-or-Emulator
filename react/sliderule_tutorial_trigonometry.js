...
trigonometryLessons ['Sine of an angle'] = function (message) {
  ...
  {action: function () {isolate (["S", "C"]), changeMarkings ('hairline', true); dimmm (255, 80, 8);}, delay: 500},
  ...
  {action: function () {cursorTo ("C", 1); dimmm (80, 255, 8);
...
trigonometryLessons ['Tangent of an angle'] = function (message) {
  ...
  {action: function () {isolate (["T", "C"]), changeMarkings ('hairline', true); dimmm (255, 80, 8);}, delay: 500},
...
trigonometryLessons ['Angle of a sine'] = function (message) {
  ...
  {action: function () {isolate (["S", "C"]), changeMarkings ('hairline', true); dimmm (255, 80, 8);}, delay: 500},
  {action: function () {message ("Move the cursor to " + sine * 10 + " on the C scale.");}, delay: 3000},
  {action: function () {cursorTo ("C", sine * 10);}, delay: 3000},
  {action: function () {message ("Read the value of " + angle + " on the S scale.");}, delay: 3000},
  {action: function () {cursorTo ("C", 1); dimmm (80, 255, 8);
  sliderules . objective = function () {
    if (checkValue ("C", sine * 10)) {message ("Mission accomplished!"); increaseCookieResult ('Angle of a sine'); return true;}
    return false;
  }}, delay: 6000},
  {action: function () {isolate (); message ("Try these instruction again.");}, delay: 4000}
  ];
...
trigonometryLessons ['Angle of a tangent'] = function (message) {
  ...
  {action: function () {isolate (["T", "C"]), changeMarkings ('hairline', true); dimmm (255, 80, 8);}, delay: 500},
  {action: function () {message ("Move the cursor to " + tangent * 10 + " on the C scale.");}, delay: 3000},
  ...
  {action: function () {cursorTo ("C", 1); dimmm (80, 255, 8);
  sliderules . objective = function () {
    if (checkValue ("C", tangent * 10)) {message ("Mission accomplished!"); increaseCookieResult ('Angle of a tangent'); return true;}
    return false;
  }}, delay: 6000},
  {action: function () {isolate (); message ("Try these instruction again.");}, delay: 4000}
  ];
