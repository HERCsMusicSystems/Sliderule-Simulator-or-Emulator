...
userTrial ['Moving Cursor test'] = function (message) {
  ...
  sliderules . objective = function () {
    if (checkValue ("A", a)) {message ("Mission accomplished!"); increaseCookieResult ('trial cursor'); isolate (); return true;}
    return false;
  };
  return null;
};
...
userTrial ['Moving Slide test'] = function (message) {
  ...
  sliderules . objective = function () {
    if (checkValue ("B", a)) {message ("Mission accomplished!"); increaseCookieResult ('trial slide'); isolate (); return true;}
    return false;
  };
  return null;
};
